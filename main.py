...
class Libri(QWidget):
    ...
    def Label(self):
        ...
        self.label1.setFont(QtGui.QFont('Blackadder ITC', int(H/10)))
    ...
    def createTable(self):
        ...
        riga = 0
        colonna = 0
        Argomenti = ["ID Libro", "Titolo", "Autore", "Casa Editrice", "Scuola", "Possenti", "Stato"]
...
class RestituireLibro(QWidget):
    ...
    def Label(self):
        ...
        self.label.setFont(QtGui.QFont('Blackadder ITC', int(H/10)))
...
class LibriInPossesso(QWidget):
    ...
    def createTable(self):
        ...
        riga = 0
        colonna = 0
        Argomenti = ["ID Prestito", "ID Libro", "ID Utente", "Data presa"]
        self.tableWidget.setHorizontalHeaderLabels(Argomenti)

        for x, item in LibriPrestati.items():
            if item['ID Utente'] == "234abcd":
...
class PrendereInPrestito(QWidget):
    ...
    def Buttons(self):
        self.button1 = Button("Indietro", self, int(W*3/4), int(H/22), self.Indietro, 7, 6)
...
class App(QWidget):
    ...
    def Buttons(self):
        ...
        self.Button4 = Button("Prendere libro in prestito", self, int(W*3/4) - int(H/10), int(H*3/4) - int(H/7), self.show_PrendereInPrestito, 8, 5)
